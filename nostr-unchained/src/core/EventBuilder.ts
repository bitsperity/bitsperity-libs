...
export class EventBuilder {
  ...
  private static isEmptyContentAllowed(kind?: number): boolean {
    ...
    const emptyContentKinds = [
      ...
      34550, // NIP-72: Community definition (replaceable, tags carry metadata)
      4550,  // NIP-72: Approval event (content may embed JSON, but can be empty by clients)
      27235, // NIP-98: HTTP Auth event (content not required)
      1063,  // NIP-94: File metadata event (content optional)
